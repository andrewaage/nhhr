...
Now, create a variable which devides Credit_amount in three groups: < 1000, 1000 - 2000 and > 2000. You can use the function *case_when*, which is similar to if_else but for can be used in cases with more than 2 options.
